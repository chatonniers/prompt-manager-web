...
const TR = {
  en: {
    ...
    basics: {
      ...
      workspaceTip: 'Use the Library / My Prompts toggle in the top bar to switch. Create new prompts in My Prompts to draft privately before sharing.',
  ...
  fr: {
    ...
    basics: {
      ...
      workspaceTip: 'Utilisez le bouton Bibliothèque / Mes Prompts dans la barre supérieure pour basculer. Créez de nouveaux prompts dans Mes Prompts pour brouiller en privé avant de partager.',
